...
### 3.1 Core Features
- [x] **Book Management**: Add, Edit, Delete books.
- [x] **Reading Status**: Want to Read, Reading, Completed.
- [x] **Notes/Reviews**: Record text notes and ratings.
...
- [x] **Update Strategy**: Strict force update.
